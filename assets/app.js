...
const SERVICES = [
  ...
  { icon:"🌉", img:"fiber-bridge-1", img2:"fiber-bridge-2", slug:"fiber-bridge", pr:"৳22,000–24,000", dur:"1 Session", durbn:"১ সিটিং", en:"Fiber Bridge", bn:"ফাইবার ব্রিজ", de:"Fixed fiber bridge to replace a missing tooth in a single session.", db:"এক সিটিংয়েই হারানো দাঁতের জায়গায় স্থায়ী নকল দাঁত।",
