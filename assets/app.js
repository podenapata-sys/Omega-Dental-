...
const SERVICES = [
  ...
  { icon:"🦿", img:"dentures-flexible", vid:"dentures-animation-sm", slug:"dentures", pr:"৳5,000–8,000", per:true, dur:"3 Visits", durbn:"৩ ভিজিট", en:"Flexible Denture", bn:"ফ্লেক্সিবল ডেনচার", cne:"Removable teeth set", cn:"বাঁধানো দাঁত", de:"Removable denture for comfortable chewing and a confident smile.", db:"আরামে চিবানো ও সুন্দর হাসির জন্য খুলে-লাগানো যায় এমন নকল দাঁত।", gal:["dentures","dentures-partial"],
