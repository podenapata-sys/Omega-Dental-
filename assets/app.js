...
const SERVICES = [
  ...
  { icon:"🌉", img:"fiber-bridge-2", img2:"fiber-bridge-1", slug:"fiber-bridge", pr:"৳22,000–24,000", dur:"1 Session", durbn:"১ সিটিং", en:"Fiber Bridge", bn:"ফাইবার ব্রিজ", de:"Fixed fiber bridge to replace a missing tooth in a single session.", db:"এক সিটিংয়েই হারানো দাঁতের জায়গায় স্থায়ী নকল দাঁত।",
    sub:[{en:"Premium · 2yr Warranty",bn:"প্রিমিয়াম · ২ বছরের ওয়ারেন্টি",slug:"fiber-bridge"}] },
  { icon:"👑", img:"crowns-bridges", slug:"crowns-bridges", pr:"৳5,000–15,000", per:true, dur:"2 Sessions", durbn:"২ সিটিং", en:"Zirconia & PFM Crown", bn:"জিরকোনিয়া ও পিএফএম ক্রাউন", cne:"Tooth cap", cn:"দাঁতের ক্যাপ", de:"Zirconia, PFM and composite crown to rebuild strength and beauty.", db:"ভাঙা বা দুর্বল দাঁত ঢেকে শক্ত ও সুন্দর করতে দাঁতের ক্যাপ।" },
  { icon:"🦿", img:"dentures-flexible", vid:"dentures-animation-sm", slug:"dentures", pr:"৳4,000–22,000", dur:"3–4 Visits", durbn:"৩–৪ ভিজিট", en:"Denture", bn:"ডেনচার", cne:"Removable teeth set", cn:"বাঁধানো দাঁত", de:"Removable denture for comfortable chewing and a confident smile.", db:"আরামে চিবানো ও সুন্দর হাসির জন্য খুলে-লাগানো যায় এমন নকল দাঁত।",
  ...
  { icon:"✨", img:"whitening-stained", img2:"teeth-whitening", slug:"teeth-whitening", pr:"৳12,000", dur:"1 Session", durbn:"১ সিটিং", en:"Teeth Whitening", bn:"দাঁত সাদা করা", cne:"Teeth whitening", cn:"দাঁত সাদা করা", de:"Brighten your smile several shades with safe professional whitening.", db:"নিরাপদে দাঁতের হলদে ভাব দূর করে কয়েক শেড উজ্জ্বল হাসি।" },
