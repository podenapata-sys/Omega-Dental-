...
const SERVICES = [
  ...
  { icon:"🌉", img:"fiber-bridge-2", img2:"fiber-bridge-1", slug:"fiber-bridge", pr:"৳22,000–24,000", per:true, dur:"1 Session", durbn:"১ সিটিং", en:"Fiber Bridge", bn:"ফাইবার ব্রিজ", de:"Fixed fiber bridge to replace a missing tooth in a single session.", db:"এক সিটিংয়েই হারানো দাঁতের জায়গায় স্থায়ী নকল দাঁত।", gal:["fiber-bridge-3","fiber-bridge-4"],
    sub:[{en:"Premium · 2yr Warranty",bn:"প্রিমিয়াম · ২ বছরের ওয়ারেন্টি",slug:"fiber-bridge"}] },
  { icon:"👑", img:"zirconia-crown", img2:"pfm-crown", vid:"crown-animation-sm", slug:"crowns-bridges", pr:"৳5,000–15,000", per:true, dur:"2 Sessions", durbn:"২ সিটিং", en:"Zirconia & PFM Crown", bn:"জিরকোনিয়া ও পিএফএম ক্রাউন", cne:"Tooth cap", cn:"দাঁতের ক্যাপ", de:"Zirconia, PFM and composite crown to rebuild strength and beauty.", db:"ভাঙা বা দুর্বল দাঁত ঢেকে শক্ত ও সুন্দর করতে দাঁতের ক্যাপ।", gal:["crowns-bridges","crowns-diagram","crown-bridge-overview"] },
  { icon:"🦿", img:"dentures-flexible", vid:"dentures-animation-sm", slug:"dentures", pr:"৳5,000–8,000", per:true, dur:"2–3 Sessions", durbn:"২–৩ সেশন", en:"Flexible Denture", bn:"ফ্লেক্সিবল ডেনচার", cne:"Removable teeth set", cn:"বাঁধানো দাঁত", de:"Removable denture for comfortable chewing and a confident smile.", db:"আরামে চিবানো ও সুন্দর হাসির জন্য খুলে-লাগানো যায় এমন নকল দাঁত।", gal:["dentures","dentures-partial"],
...
const I18N = {
  ...
  bn: {
    ...
    hero_text:"ওমেগা ডেন্টালে আধুনিক, ব্যথাহীন ও কম খরচে দাঁতের চিকিৎসা। সাধারণ চেকআপ থেকে নতুন দাঁত বসানো আর হাসি সুন্দর করা — সবার আগে আপনার আরাম।",
    hero_b1:"ব্যথাহীন চিকিৎসা", hero_b2:"আধুনিক যন্ত্রপাতি", hero_b3:"কম খরচ", hero_b4:"অভিজ্ঞ ডাক্তার",
    ...
    services_title:"এক জায়গাতেই দাঁতের সব চিকিৎসা",
    services_text:"আপনার দরকারি সব চিকিৎসা — আধুনিক যন্ত্রে, কোমলভাবে আর পরিষ্কার দামে।",
    ...
    why1:"ব্যথা ও ভয় ছাড়া চিকিৎসা", why2:"ভালোভাবে জীবাণুমুক্ত ও নিরাপদ", why3:"পরিষ্কার ও কম দাম",
    ...
    foot_about:"ঢাকায় আধুনিক, ব্যথাহীন ও কম খরচে দাঁতের চিকিৎসা। পুরো পরিবারের সুস্থ হাসি।",
...
function renderServices(){
  ...
  wrap.innerHTML = SERVICES.map((s)=>{
    ...
    const media = s.vid
      ? `<img class="svc-static" src="assets/services/${s.img}.jpg?v=2" onerror="this.onerror=null;this.src='assets/services/${s.img}.svg?v=3'" alt="${name}" loading="lazy"><video class="svc-anim" autoplay muted loop playsinline preload="metadata"><source src="assets/services/${s.vid}.mp4?v=2" type="video/mp4"></video>`
      : s.img2
