...
const I18N = {
  en: {
    ...
    services_text:"Every treatment you need — modern, 100% sterile and affordable.",
  ...
  bn: {
    ...
    services_text:"আপনার দরকারি সব সেবা — আধুনিক যন্ত্র, ১০০% সম্পূর্ণ জীবাণুমুক্ত আর কম দামে।",
